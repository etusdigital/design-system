...
const lt = /* @__PURE__ */ G(Et, [["render", Tt], ["__scopeId", "data-v-08c8d5cf"]]), Lt = ["id", "name", "type", "disabled"], Pt = ["for"], zt = /* @__PURE__ */ Z({
  __name: "BButton",
  props: {
    id: {},
    name: {},
  ...
  setup(n) {
    ...
    return (c, t) => (f(), v("button", {
      ...
      name: c.name || c.id,
      type: c.type,
      disabled: c.disabled || e.value,
      class: A(["b-button", [
        {
          disabled: c.disabled || e.value,
          "pointer-events-none": e.value && !c.disabled
        },
        c.variant,
        c.size,
        c.color
...
}), at = /* @__PURE__ */ G(zt, [["__scopeId", "data-v-f18901c3"]]), Ot = {
  install(n) {
...
function He(n, s, e, c = { left: !0 }, t = {}, l = {}) {
  const o = n.clientX - s.clientWidth / 2 - e.getBoundingClientRect().left, u = e.clientWidth - (s.clientWidth - (typeof t.x == "number" ? t.x : 2)), d = Math.min(
    u,
    Math.max(l.x || 0, c.left ? o : u - o)
  ), a = n.clientY - s.clientHeight / 2 - e.getBoundingClientRect().top, r = e.clientHeight - (s.clientHeight - (t.y || 0)), m = Math.min(
    r,
...
function nt(n, s) {
  switch (s) {
    case "cpf":
      ...
      break;
    case "cnpj":
      n = n.replace(/\D/g, ""), n = n.slice(0, 14), n = n.replace(/(\d{2})(\d)/, "$1.$2"), n = n.replace(/(\d{2})\.(\d{3})(\d)/, "$1.$2.$3"), n = n.replace(/(\d{2})\.(\d{3})\.(\d{3})(\d)/, "$1.$2.$3/$4"), n = n.replace(
        /(\d{2})\.(\d{3})\.(\d{3})\/(\d{4})(\d)/,
        "$1.$2.$3/$4-$5"
      );
      break;
...
const el = ["id", "name", "aria-checked", "aria-disabled"], tl = ["for"], ll = {
  ...
  setup(n, { emit: s }) {
    const e = n, c = s, [t] = se(
      ...
      c,
      !1
    ), l = Y(() => e.allowIndeterminate ? t.value !== !1 : !!t.value), o = Y(() => t.value === null ? "mixed" : !!t.value);
    function u() {
...
}), Bl = /* @__PURE__ */ G(Cl, [["__scopeId", "data-v-a436ef6f"]]), wl = {
  install(n) {
  ...
  emits: ["update:modelValue"],
  setup(n, { emit: s }) {
    const e = n, c = s, [t, l] = se(
      e,
      "modelValue",
      c,
      !1
    ), o = S(), u = S(), d = S(), a = new ResizeObserver(p), r = new MutationObserver(p), m = Y(
      () => e.disabled ? !1 : t.value
    );
    he(() => {
      u.value && (o.value = u.value.querySelector(
        ".b-label-container"
  ...
  setup(n, { emit: s }) {
    const e = n, c = s, [t] = se(e, "modelValue", c, ""), [l, o] = se(
      e,
      "expanded",
      c,
      !1
...
}), Pe = /* @__PURE__ */ G(Tl, [["__scopeId", "data-v-e4c3c647"]]), Ll = /* @__PURE__ */ Z({
  __name: "Option",
  props: {
...
}), Ve = /* @__PURE__ */ G(Ll, [["__scopeId", "data-v-7c65acf2"]]), Pl = /* @__PURE__ */ Z({
  __name: "BSelect",
  props: {
...
}, Fl = { class: "flex flex-col gap-xxs" }, Nl = {
  key: 0,
  class: "title"
}, _l = {
  key: 1,
      ...
      P(ve, { name: "content" }, {
        default: D(() => [
          g("div", {
            ...
            x(r.$slots, "default", {}, () => [
              g("div", Fl, [
                r.title ? (f(), v("h6", Nl, F(r.title), 1)) : T("", !0),
                !r.expandable || B(t) ? (f(), v("p", _l, F(r.message), 1)) : T("", !0)
              ])
            ], !0)
          ], 512)
        ]),
...
}), ft = /* @__PURE__ */ G(Ql, [["__scopeId", "data-v-97457df7"]]), Yl = /* @__PURE__ */ Z({
  __name: "BDialog",
  props: {
    modelValue: { type: Boolean, default: !1 },
  ...
  emits: ["update:modelValue"],
  setup(n, { emit: s }) {
    const e = n, c = new MutationObserver(p), t = s, [l, o] = se(
      e,
      "modelValue",
      t,
      !1
  ...
  setup(n, { emit: s }) {
    ...
    return (i, b) => {
      ...
      return f(), R(mt, {
        ...
        "onUpdate:modelValue": b[1] || (b[1] = (z, _) => i.$emit("update:expandedModel", z))
      }, Be({
        items: D(() => [
          (f(!0), v(Q, null, le(Object.entries(i.modelValue), (z, _) => (f(), v("li", {
            role: "option",
            "aria-selected": (
              // @ts-ignore
              i.modelValue[_][i.selectedKey]
            ),
            key: z[0],
            class: A(["flex flex-col gap-[.75em] select-none h-max transition-[height] max-h-[3em] overflow-hidden", { active: B(u) === _ }]),
            tabindex: _,
            ...
            g("div", {
              class: A(["flex items-center justify-between text-neutral-interaction-default w-full h-full cursor-pointer *:p-xs hover:text-primary-interaction-default hover:bg-primary-surface-hover", {
                "bg-primary-surface-default text-primary-interaction-default font-bold": B(u) === _
              }]),
              onClick: We((U) => m(_), ["prevent"]),
              onKeyup: me((U) => m(_), ["space"])
            }, [
              g("p", ma, F(z[0]), 1),
              g("div", va, [
                ...
                g("div", {
                  class: A(["flex items-center w-fit h-fit transition-transform ease-in-out duration-300 cursor-pointer text-xl", [
                    B(u) === _ ? "rotate-180 text-primary-interaction-default" : "text-neutral-interaction-default"
                  ]])
                }, [
                  P(W, {
                    name: "expand_more",
  ...
  setup(n, { emit: s }) {
    ...
    function M(k) {
      isNaN(Number(t.value)) && (t.value = 0), !e.disabled && ((e.max || e.max === 0) && t.value >= e.max && k > 0 || (e.min || e.min === 0) && t.value <= e.min && k < 0 || (t.value = (Number(t.value) * 1e3 + k * 1e3) / 1e3, _()));
    }
    function q(k, $ = !1) {
      return I(e.mask, k, $);
    }
...
}), Wa = /* @__PURE__ */ G(Oa, [["__scopeId", "data-v-e3e8f0fb"]]), Ua = {
  install(n) {
...
}), vt = /* @__PURE__ */ G(Ra, [["__scopeId", "data-v-d852b63f"]]), Fa = { class: "b-menu" }, Na = /* @__PURE__ */ Z({
  __name: "BMenu",
  props: {
    modelValue: { default: void 0 },
    items: {},
...
}), _a = /* @__PURE__ */ G(Na, [["__scopeId", "data-v-93bc751c"]]), qa = {
  install(n) {
    n.component("BMenu", _a);
  }
}, Za = ["src"], Ka = { class: "text-sm font-bold" }, Xa = { class: "flex flex-col items-center text-9xl px-xs pb-sm border-b-xxs text-neutral-interaction-default border-neutral-border-default gap-xs" }, Ga = ["src"], Ja = {
  key: 2,
...
}, eo = { class: "flex items-center w-full relative" }, to = { class: "w-full flex flex-col divide-y-xxs divide-neutral-border-default font-bold max-h-[12em] overflow-auto custom-scroll" }, lo = ["onClick"], ao = { class: "flex flex-col divide-y-xxs divide-neutral-border-default" }, oo = { class: "text-sm font-bold" }, no = { class: "text-sm font-bold" }, so = { class: "flex items-center justify-center px-xs py-sm pt-xl text-neutral-interaction-default font-bold text-xxs gap-5 *:cursor-pointer" }, io = /* @__PURE__ */ Z({
  __name: "BProfile",
  props: {
    modelValue: { default: void 0 },
    name: {},
...
}), ro = /* @__PURE__ */ G(io, [["__scopeId", "data-v-ae2a966c"]]), uo = {
  install(n) {
...
}), Co = /* @__PURE__ */ G(yo, [["__scopeId", "data-v-54b467fa"]]), Bo = {
  install(n) {
...
}), Ao = /* @__PURE__ */ G(Io, [["__scopeId", "data-v-6c115e01"]]), So = {
  install(n) {
    n.component("BTab", Ao);
  }
...
}, jo = { key: 1 }, Ro = { colspan: "100%" }, Fo = { key: 3 }, No = { key: 4 }, _o = {
  key: 0,
  ...
  setup(n, { emit: s }) {
    ...
    const e = n, c = s, t = tt(), l = S(((U = e.options) == null ? void 0 : U.sortBy) || ""), o = S(e.items || []), u = S(b()), d = S(e.itemsPerPage || 10), a = S(e.page || 1), r = S([5, 10, 20, 50, 100]), m = S(!1), p = Y(() => {
      ...
      () => (a.value - 1) * d.value + o.value.length
    ), w = Y(
      () => {
        var H;
      ...
      return f(), v(Q, null, [
        g("div", {
          ...
          g("table", Do, [
            ...
            H.$slots.footer ? (f(), v("tfoot", No, [
              x(H.$slots, "footer", {}, void 0, !0)
            ])) : T("", !0)
          ])
        ], 2),
        H.hideFooter ? T("", !0) : (f(), v("footer", _o, [
          g("div", qo, [
            g("p", Zo, [
...
}), Go = /* @__PURE__ */ G(Xo, [["__scopeId", "data-v-93ecbc98"]]), Jo = {
  install(n) {
...
}), tn = /* @__PURE__ */ G(en, [["__scopeId", "data-v-bf893b2f"]]), ln = /* @__PURE__ */ Z({
  __name: "DateDialog",
  props: {
...
}), Qe = /* @__PURE__ */ G(ln, [["__scopeId", "data-v-1102da5d"]]), an = { class: "b-calendar flex relative w-fit" }, on = { class: "relative flex items-center justify-center gap-xs mb-xs" }, nn = ["onClick"], sn = { key: 0 }, rn = { class: "*:p-xxs" }, un = ["onClick"], dn = ["onClick"], cn = /* @__PURE__ */ Z({
  __name: "Calendar",
  props: {
    modelValue: {},
    initialDates: {},
  ...
  setup(n, { emit: s }) {
    const e = n, c = s, [t, l] = se(
    ...
    ), o = S(!0), u = S(!0), d = S(!1), a = S(!1), r = S(), m = S(0), p = Y(() => {
      ...
      e.initialDates.map((C) => i(C.date, C.value))
    );
    ae(
      () => e.lang,
      () => {
    ...
    function U(C) {
      return a.value || d.value ? Ge(
        C.toLocaleDateString(e.lang, { year: "numeric" })
      ) : Ge(
        C.toLocaleDateString(e.lang, { year: "numeric", month: "long" })
      );
    }
    function H(C, I) {
...
}), gt = /* @__PURE__ */ G(cn, [["__scopeId", "data-v-79788d4a"]]), fn = /* @__PURE__ */ Z({
  __name: "BDate",
  props: {
    modelValue: {},
    lang: { default: "en-US" },
...
}), gn = /* @__PURE__ */ G(vn, [["__scopeId", "data-v-63b8931c"]]), hn = {
  install(n) {
    n.component("BTag", gn);
  }
  ...
  setup(n, { emit: s }) {
    var p;
    const e = n;
    let c = S(!1), t = S(e.modelValue ? e.modelValue : []), l = S(
...
}), Mn = /* @__PURE__ */ G($n, [["__scopeId", "data-v-a8f88fca"]]), xn = {
  install(n) {
...
}), An = /* @__PURE__ */ G(In, [["__scopeId", "data-v-38c2e3dd"]]), Sn = {
  install(n) {
...
}), Hn = /* @__PURE__ */ G(En, [["__scopeId", "data-v-aad4eaaa"]]), Tn = {
  install(n) {
...
const Rn = /* @__PURE__ */ G(Pn, [["render", jn]]), Fn = {
  ...
  setup(n) {
    ...
    return (l, o) => {
      ...
      return f(!0), v(Q, null, le(e.value, (d) => (f(), v("div", {
        ...
        (f(!0), v(Q, null, le(s.value.filter(
...
}), _n = /* @__PURE__ */ G(Nn, [["__scopeId", "data-v-81d6c967"]]), qn = {
  install(n) {
    n.component("BToast", _n);
  }
}, Zn = /* @__PURE__ */ Z({
  ...
  setup(n, { emit: s }) {
    ...
    const c = s;
    let t = S(e.expanded), l = S(!1), o = S(
      e.options.length && !e.isCompare && ((w = e.options.find((i) => i.selected)) == null ? void 0 : w.value) || ""
    ), u = S(
    ...
    return (i, b) => {
      const W = O("BIcon"), V = O("BCheckbox"), E = O("BDateComparator"), z = O("BButton"), _ = O("BExpandableContainer");
      return f(), R(_, {
        modelValue: B(t),
        "onUpdate:modelValue": [
    ...
    return (r, m) => (f(), R(mt, {
      ...
      content: D(({ minWidth: p }) => [
        fe(g("div", {
          ...
          g("div", {
            class: A(["content -translate-y-full transition-translate duration-100 ease-out mt-xs", [{ "translate-y-[0]": u.value }]])
          }, [
            x(r.$slots, "card", {}, () => [
              g("div", {
                ref: "contentRef",
                class: "bg-neutral-surface-default shadow-neutral-selected border-xxs border-neutral-default rounded-xs",
                style: ie(`max-height: ${r.maxHeight}px`)
              }, [
                g("div", os, [
                  x(r.$slots, "content")
                ])
  ...
  setup(n, { emit: s }) {
    ...
    const t = S(!1), l = S(!1), o = S(!1), u = S(), d = S(), a = S(), r = S(), m = S(e.modelValue || "rgba(255, 255, 255, 1)"), p = S("hsl(0, 100%, 50%)"), h = S(1), y = S(e.modelValue || V()), w = S(["hexa", "hsla", "hwb", "hsva", "rgba"]), i = S(
      w.value.findIndex((L) => L == e.type) !== -1 ? w.value.findIndex((L) => L == e.type) : 0
    ), b = S(!1), W = S(!1);
    function V() {
    ...
    function I(L) {
      var K;
      if (l.value && d.value) {
        const N = d.value.closest(".slider"), X = (K = r.value) == null ? void 0 : K.getContext("2d");
        if (!N || !r.value || !X) return;
        const J = te(
          L,
          d.value,
          N
        ...
        const re = N.clientWidth - 10, ye = J / re;
    ...
    function k(L) {
      var K, N;
      if (t.value && u.value) {
        const X = (K = u.value) == null ? void 0 : K.closest(".slider"), J = (N = d.value) == null ? void 0 : N.closest(
          ".slider"
        );
    ...
    function $(L) {
      var K;
      if (o.value && a.value) {
        const N = (K = r.value) == null ? void 0 : K.getContext("2d");
        if (!r.value || !N) return;
        const X = te(
          L,
          a.value,
    ...
    function j(L, K) {
      ...
      if (!X) return "";
      const J = X.createLinearGradient(0, 0, N.width, 0);
      J.addColorStop(0, "hsl(0, 100%, 50%)"), J.addColorStop(1 / 6, "hsl(60, 100%, 50%)"), J.addColorStop(2 / 6, "hsl(120, 100%, 50%)"), J.addColorStop(3 / 6, "hsl(180, 100%, 50%)"), J.addColorStop(4 / 6, "hsl(240, 100%, 50%)"), J.addColorStop(5 / 6, "hsl(300, 100%, 50%)"), J.addColorStop(1, "hsl(360, 100%, 50%)"), X.fillStyle = J, X.fillRect(0, 0, N.width, N.height);
      const re = X.getImageData(K, 0, 1, 1).data;
      return `rgba(${re[0]}, ${re[1]}, ${re[2]}, ${re[3] / 255})`;
    }
    function ee(L = "hsl(0, 100%, 50%)", K = 1) {
      const N = r.value, X = N == null ? void 0 : N.getContext("2d");
      if (!X || !N) return;
      N.width = N.clientWidth, N.height = N.clientHeight, X.clearRect(0, 0, N.width, N.height), X.globalAlpha = K;
      const J = X.createLinearGradient(0, 0, N.width, 0);
      J.addColorStop(0, "#ffffff"), J.addColorStop(1, L);
      const re = X.createLinearGradient(0, 0, 0, N.height);
      re.addColorStop(0, "rgba(0, 0, 0, 0)"), re.addColorStop(1, "#000000"), X.fillStyle = J, X.fillRect(0, 0, N.width, N.height), X.fillStyle = re, X.fillRect(0, 0, N.width, N.height);
    }
    function te(L, K, N, X = !1) {
      const J = He(
        L,
        K,
        N,
    ...
    function ue() {
      ...
      const K = Number(a.value.style.left.replace("px", "")) + 5, N = Number(a.value.style.top.replace("px", "")), X = L.getImageData(
        Math.min(r.value.clientWidth - 1, K),
        Math.min(r.value.clientHeight - 1, N),
        1,
        1
      ).data;
    ...
    function pe() {
      ...
      if (!u.value || !d.value || !a.value || !L || !K)
        return;
      const N = be(), X = Math.min(1, N.h / 360), J = Math.min(
        L.clientWidth - 10,
        Math.max(0, (L.clientWidth - 10) * X)
      ), re = K.clientWidth - 10, ye = Math.min(
        re,
        Math.max(0, re * N.a)
      ), Ne = ye / re;
      h.value = Ne, u.value.style.left = J + "px", d.value.style.left = ye + "px";
      const Oe = j(L, J);
      ...
      const Vt = jt(
        N.h,
        Number(N.s.toString().replace("%", "")),
        Number(N.v.toString().replace("%", "")),
        N.a
      );
      m.value = Ct(Vt);
      const _e = Bt(N);
      a.value.style.left = _e.x + "px", a.value.style.top = _e.y + "px", c("update:modelValue", y.value);
    }
    function be() {
      var K;
      if (i.value == 0) {
        const N = Wt(y.value);
        return Ae(N.r, N.g, N.b, isNaN(N.a) ? 1 : N.a);
      } else if (i.value == 1) {
        const N = Me(y.value, "hlsa"), X = ot(N.h, N.s, N.l, N.a);
        return Ae(X.r, X.g, X.b, isNaN(X.a) ? 1 : X.a);
      } else if (i.value == 2) {
        const N = Me(y.value, "hwb", " "), X = y.value.split("/"), J = Ut(
          N.h,
          N.w,
          N.b,
    ...
    function Me(L, K = "rgba", N = ",") {
      if (!L) return "";
      const X = {}, J = Array.from(K), re = L.split(N);
      return Fe(J, re, X);
    }
    function yt(L, K = ",") {
      if (!L) return "";
    ...
    function Fe(L, K, N) {
      return L.forEach((X, J) => {
        N[X] = typeof K[J] == "string" ? Number(K[J].replace("%", "")) : K[J] || 1;
      }), N;
    }
    function Ct(L) {
      let K = "", N = "";
      return Object.keys(L).forEach((X, J) => {
        N += X, K += Object.keys(L).length - 1 == J ? L[X] : `${L[X]}, `;
      }), `${N}(${K})`;
    }
    function Bt(L) {
      const K = r.value;
      ...
      const N = {
        ...
        -5,
        Math.min(
          N.s / 100 * (K.clientWidth - 5),
          K.clientWidth - 5
        )
      ), J = Math.max(
        0,
        Math.min(
          (1 - N.v / 100) * K.clientHeight,
          K.clientHeight
        )
      );
      return {
    ...
    return (L, K) => {
      const N = O("BInput"), X = O("BIcon"), J = O("BCard");
      return f(), R(J, {
        id: "b-color-picker",
...
}), vs = /* @__PURE__ */ G(ms, [["__scopeId", "data-v-5f44c89c"]]), gs = {
  install(n) {
  ...
  setup(n, { emit: s }) {
    ...
    he(() => {
      ...
      () => {
        t.value = w(), M();
        const C = i();
        (!e.modelValue || !e.modelValue.length || C.find(
          (I, k) => e.modelValue && I != e.modelValue[k]
        ) != null) && c("update:modelValue", C);
      }
    ), ae(
      () => e.vertical,
      () => {
    ...
    function m(C) {
      const I = C * 100 + "%", k = {};
      if (e.vertical ? k.bottom = I : k.left = I, e.disabled) return k;
    ...
    function M() {
      ...
      (C = o.value) == null || C.forEach((I, k) => {
        if (!(!I || !d.value))
          if (e.vertical) {
            const $ = d.value.clientHeight, j = Math.min(
              $,
              Math.max(0, $ * t.value[k])
            ), ee = Number(I.style.borderWidth.replace("px", "")) / 2;
            I.style.bottom = j - I.clientHeight / 3 - ee + "px", I.style.left = "50%";
          } else {
            const $ = d.value.clientWidth, j = Math.min(
              $,
              Math.max(0, $ * t.value[k])
            ), ee = Number(
              I == null ? void 0 : I.computedStyleMap().get("--border-width-xs").toString().replace("px", "")
            ) / 2;
    ...
    function q() {
      if (!(!u.value || !o.value || !d.value))
        if (e.vertical) {
          const C = d.value.clientHeight, I = o.value.map(
            (te) => te.clientHeight / 2
          ), $ = o.value.map((te) => te.offsetTop).map(
            (te, ue) => C - te - I[ue]
          ), j = e.isRange ? Math.min(...$) : 0, ee = Math.max(0, Math.max(...$));
          u.value.style.bottom = j + "px", u.value.style.height = Math.abs(ee - j) + "px", u.value.style.left = "50%", u.value.style.width = "100%";
        } else {
          const C = o.value.map(
            ($) => $.offsetLeft + $.clientWidth / 3
          ), I = e.isRange ? Math.min(...C) : 0, k = Math.max(...C);
...
}), ht = /* @__PURE__ */ G(ys, [["__scopeId", "data-v-191a1d42"]]), Cs = /* @__PURE__ */ Z({
  __name: "BSlider",
  props: {
...
}), Is = /* @__PURE__ */ G(xs, [["__scopeId", "data-v-a64348c7"]]), As = {
  install(n) {
...
}, Es = { class: "max-w-full" }, Hs = { class: "whitespace-normal break-all" }, Ts = ["disabled", "placeholder"], Ls = { key: 1 }, Ps = { class: "p3 text-neutral-foreground-low" }, zs = {
  key: 0,
  class: "error-default"
}, Os = /* @__PURE__ */ Z({
  __name: "BTagInput",
  ...
  setup(n, { emit: s }) {
    ...
    function m() {
      var q;
      const M = (q = a.value) == null ? void 0 : q.querySelector(
        "#input-default"
      );
      l.value = !0, M && M.focus();
    }
...
`);
    ...
    function H(M) {
      ...
      q = nt(q, e.mask), e.mask == "email" ? z(q) : e.mask == "domain" ? _(q) : e.mask == "url" && U(q);
    }
    return (M, q) => {
...
}), Ks = /* @__PURE__ */ G(Zs, [["__scopeId", "data-v-2418cd4b"]]), Xs = {
  install(n) {
...
}), Ys = /* @__PURE__ */ G(Qs, [["__scopeId", "data-v-a298c37e"]]), ei = {
  install(n) {
  ...
  setup(n, { emit: s }) {
    ...
    const t = Y(() => r.value ? u.value.filter((V) => {
      ...
      if (de(V)) {
        if ((z = (E = V[e.labelKey]) == null ? void 0 : E.toLowerCase()) != null && z.includes(r.value.toLowerCase()))
          return V;
      } else if ((_ = V == null ? void 0 : V.toLowerCase()) != null && _.includes(r.value.toLowerCase()))
        return V;
    }) : u.value), [l, o] = se(
      e,
      "modelValue",
    ...
    return (V, E) => {
      const z = O("BIcon"), _ = O("BTag"), U = O("BRoundButton"), H = O("BSelectContainer");
      return f(), R(H, {
        modelValue: a.value,
        "onUpdate:modelValue": [
          E[6] || (E[6] = (M) => a.value = M),
...
}), ci = /* @__PURE__ */ G(di, [["__scopeId", "data-v-6d6aacab"]]), fi = {
  install(n) {
...
}), bi = /* @__PURE__ */ G(hi, [["__scopeId", "data-v-5ac3734f"]]), yi = {
  install(n) {
  ...
  setup(n, { emit: s }) {
    ...
    const r = S({
      ...
      var z, _;
      return (document.readyState === "complete" || document.readyState === "interactive") && ((_ = (z = t.value) == null ? void 0 : z.computedStyleMap().get("--border-radius-xl")) == null ? void 0 : _.toString()) || "16px";
    }), h = s;
    he(async () => {
    ...
    function y() {
      var z, _, U, H;
      r.value.width = (z = t.value) != null && z.clientWidth ? ((_ = t.value) == null ? void 0 : _.clientWidth) + 10 : 0, r.value.height = (U = t.value) != null && U.clientHeight ? ((H = t.value) == null ? void 0 : H.clientHeight) + 10 : 0;
    }
    function w(z) {
      c.value = !0, b(z);
    }
    ...
    function W(z) {
      ...
      l.value.style.top = `${_.y}px`, l.value.style.left = `${_.x}px`, o.value.setAttribute("x", _.x.toString()), o.value.setAttribute("y", _.y.toString()), E(l.value, l.value.parentElement);
    }
    function V(z) {
      const _ = document.createElement("canvas"), U = _.getContext("2d");
      if (!l.value || !l.value.parentElement || !U) return;
      ...
      U.clearRect(0, 0, _.width, _.height), U.save(), U.translate(k, $), U.scale(H, H), U.translate(-k, -$), U.drawImage(a, C, I), U.restore();
      const j = _.toDataURL("image/png");
    ...
    function E(z, _) {
      ...
      const q = _.getBoundingClientRect(), C = U.left - q.left, I = U.top - q.top, k = C, $ = I, j = U.width, ee = U.height;
      M.drawImage(
        d.value,
        k,
        $,
...
}), Mi = /* @__PURE__ */ G($i, [["__scopeId", "data-v-57c9e396"]]), xi = {
  install(n) {
...
}), Di = /* @__PURE__ */ G(Si, [["__scopeId", "data-v-75c5f06f"]]), Ei = {
  install(n) {
...
}), Pi = /* @__PURE__ */ G(Li, [["__scopeId", "data-v-66d37433"]]), zi = {
  install(n) {
...
}), ji = /* @__PURE__ */ G(Ui, [["__scopeId", "data-v-5e7e299d"]]), Ri = {
  install(n) {
...
}, _i = { class: "flex items-end gap-xs" }, qi = { class: "card-description" }, Zi = {
  key: 3,
...
}), Xi = /* @__PURE__ */ G(Ki, [["__scopeId", "data-v-2787417d"]]), Gi = {
  install(n) {
...
}), nr = /* @__PURE__ */ G(or, [["__scopeId", "data-v-1ea2d426"]]), sr = {
  install(n) {
...
}), bt = /* @__PURE__ */ G(cr, [["__scopeId", "data-v-951fd625"]]), fr = { class: "flex items-center gap-xs" }, pr = { class: "label" }, mr = /* @__PURE__ */ Z({
  __name: "Item",
  props: {
    modelValue: { default: void 0 },
    selected: { type: Boolean, default: !1 },
  ...
  setup(n, { emit: s }) {
    const e = n, c = s, [t] = se(e, "modelValue", c, ""), [l] = se(
      e,
      "selected",
      c,
      !1
...
}), vr = /* @__PURE__ */ G(mr, [["__scopeId", "data-v-7f0ddff1"]]), gr = /* @__PURE__ */ Z({
  __name: "BDropdown",
  props: {
    modelValue: { default: void 0 },
    expanded: { type: Boolean, default: !1 },
          ...
          P(bt, { items: a.value }, {
            default: D(({ items: z }) => [
              (f(!0), v(Q, null, le(z, (_) => (f(), R(vr, {
                ...
                selected: _.selected,
                "onUpdate:selected": (U) => _.selected = U,
                item: _,
  ...
  setup(n, { emit: s }) {
    const e = n, c = s, [t] = se(e, "modelValue", c, void 0), l = S([]), o = Y(() => {
      var w;
      if (!((w = e.items) != null && w.length)) return [];
      const p = [...e.items];
    ...
    async function m(p, h) {
      ...
      const W = (V) => {
        const E = Math.abs(b.offsetHeight - b.scrollHeight) > 3, z = V.type == "wheel", _ = b.contains(V.target);
        (E ? z && !_ : z || !_) && (l.value[h] = !1, document.removeEventListener("click", W), document.removeEventListener("wheel", W));
      };
      setTimeout(() => {
...
}), wr = /* @__PURE__ */ G(Br, [["__scopeId", "data-v-62e326ab"]]), kr = {
  install(n) {
...
}), Mr = /* @__PURE__ */ G($r, [["__scopeId", "data-v-32d5ff9c"]]), xr = {
  install(n) {
...
}), Hr = /* @__PURE__ */ G(Er, [["__scopeId", "data-v-2cf23078"]]), Tr = {
  install(n) {
...
}), Pr = /* @__PURE__ */ G(Lr, [["__scopeId", "data-v-83bf6c9c"]]), zr = {
  install(n) {
...
}), Ur = /* @__PURE__ */ G(Wr, [["__scopeId", "data-v-2b1fb60b"]]), jr = { class: "b-side-menu" }, Rr = /* @__PURE__ */ Z({
  __name: "BSideMenu",
  props: {
    modelValue: { default: void 0 },
    items: {},
  ...
  setup(n, { emit: s }) {
    ...
    ge(() => {
      const r = o(e.items, e.parentPath).find(
        (m) => ut(m.path)
      );
      r && d(r.value);
    });
...
}), Fr = /* @__PURE__ */ G(Rr, [["__scopeId", "data-v-22bc579e"]]), Nr = {
  install(n) {
  ...
  BToggle: nl,
  BTooltip: xn
}, Symbol.toStringTag, { value: "Module" })), Ye = _r, Xr = {
  install(n) {
    ...
    for (const t in Ye) {
      const l = Ye[t];
      l && (typeof l.install == "function" || typeof l == "object") && n.use(l);
    }
