...
import * as FileUpload from './FileUpload.stories.ts';
...
<Canvas sourceState="none" of={FileUpload.Primary} />
...
<Canvas sourceState="none" of={FileUpload.WithAcceptTypes} />

#### multiple
Allows multiple file selection. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={FileUpload.MultipleFiles} />

#### is-error
Activates error styling mode. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={FileUpload.Error} />
...
<Canvas sourceState="none" of={FileUpload.InfoMessage} />

#### size
File upload component size. Type: `'xs' | 'sm' | 'base' | 'lg' | 'xl' | 'full'` (default: `"full"`)

<Canvas sourceState="none" of={FileUpload.DifferentSizes} />

#### disabled
Disables file upload interaction. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={FileUpload.Disabled} />

#### required
Marks the field as required. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={FileUpload.Required} />
