...
<Canvas sourceState="none" of={FileUpload.Accept} />

#### multiple
Allows multiple file selection. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={FileUpload.Multiple} />

#### is-error
Activates error styling mode. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={FileUpload.IsError} />
...
<Canvas sourceState="none" of={FileUpload.Sizes} />
