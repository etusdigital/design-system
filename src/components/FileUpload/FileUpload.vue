...
<template>
  ...
  >
    ...
    <div class="flex gap-sm items-center justify-center" v-else>
...
.file {
  @apply relative cursor-pointer flex flex-col gap-xs items-center justify-center w-full h-full border-neutral-default border-dashed border-xxs rounded-sm cursor-pointer py-xs px-sm;
...
.error-message {
  @apply text-sm text-danger-foreground-low;
}
</style>
