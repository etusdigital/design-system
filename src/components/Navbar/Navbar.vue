...
<template>
  <div class="navbar">
    <div class="flex items-center gap-base">
      <div class="flex items-center gap-base text-lg leading-lg font-light text-primary-foreground-high">
        <slot name="logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
            ...
            <path
              ...
              stroke="#FAFAFA" stroke-width="2.40312" stroke-miterlimit="10" />
            ...
            <path
              ...
              fill="white" />
            <defs>
              <linearGradient id="paint0_linear_2159_846" x1="34.6407" y1="5.85756" x2="6.35756" y2="34.1424"
              ...
              <radialGradient id="paint1_angular_2159_846" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                gradientTransform="translate(20.1617 17.1708) rotate(139.686) scale(8.34625 8.94344)">
                <stop stop-color="white" />
                <stop offset="1" stop-color="#DDDDDD" />
              </radialGradient>
              <linearGradient id="paint2_linear_2159_846" x1="10.8995" y1="18.5312" x2="13.7097" y2="21.3414"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="white" />
      ...
      <slot>
        <Dropdown v-if="options && options.length" v-model="model" v-model:expanded="isDropdownOpen" :options="options"
          :label-key="labelKey" :value-key="valueKey" :get-object="getObject" />
      </slot>
    </div>
    <div class="flex items-center gap-base">
      <slot name="actions">
...
.navbar {
  @apply flex items-center justify-between gap-sm w-full py-sm px-xl bg-emphasis border-xxs border-neutral-default;
}
