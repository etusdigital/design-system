...
import * as Calendar from './Calendar.stories.ts';
...
<Canvas sourceState="none" of={Calendar.Primary} />
...
<Canvas sourceState="none" of={Calendar.Lang} />
...
<Canvas sourceState="none" of={Calendar.Period} />
<Canvas sourceState="none" of={Calendar.Compare} />

#### double-calendar
Shows two calendar months side by side. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={Calendar.DoubleCalendar} />

#### min-date
Earliest selectable date constraint. Type: `Date` (default: `undefined`)

<Canvas sourceState="none" of={Calendar.MinDate} />

#### max-date
Latest selectable date constraint. Type: `Date` (default: `undefined`)

<Canvas sourceState="none" of={Calendar.MaxDate} />
