...
.secondary.primary {
  @apply text-primary-foreground-low border-primary-default;
}

.secondary.info {
  @apply text-informative-foreground-low border-informative-default;
}

.secondary.success {
  @apply text-success-foreground-low border-success-default;
}

.secondary.warning {
  @apply text-warning-foreground-low border-warning-default;
}

.secondary.danger {
  @apply text-danger-foreground-low border-danger-default;
}

.secondary.neutral {
  @apply text-neutral-foreground-low border-neutral-pressed;
}
