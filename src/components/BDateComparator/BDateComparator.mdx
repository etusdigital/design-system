...
import * as BDateComparator from './BDateComparator.stories.ts';

<Meta of={BDateComparator} />
...
<Canvas of={BDateComparator.Primary} />
<Controls />
...
<Canvas sourceState="none" of={BDateComparator.Primary} />
