...
<template>
	<div
		...
		class="alert transition-[height] duration-100">
...
<style scoped>
	...
	.alert {
		@apply flex justify-between p-base border-xxs gap-base;
	...
	.info {
		@apply bg-informative-surface-default text-informative-interaction-default;
		border-color: var(--color-informative-border-default);
	...
	.success {
		@apply bg-success-surface-default text-success-interaction-default;
	...
	.warning {
		@apply bg-warning-surface-default text-warning-interaction-default;
	...
	.danger {
		@apply bg-danger-surface-default text-danger-interaction-default;
	...
	.neutral {
		@apply bg-neutral-surface-default text-neutral-interaction-default;
