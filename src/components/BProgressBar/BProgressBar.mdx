...
import * as BProgressBar from './BProgressBar.stories';

<Meta of={BProgressBar} />
...
<Canvas of={BProgressBar.Primary} />
<Controls />
...
<Canvas sourceState="none" of={BProgressBar.Primary} />
...
<Canvas sourceState="none" of={BProgressBar.Icon} />
...
<Canvas sourceState="none" of={BProgressBar.NeutralBackground} />
...
<Canvas sourceState="none" of={BProgressBar.IconSlot} />
