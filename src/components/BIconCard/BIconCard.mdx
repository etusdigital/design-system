...
import * as BIconCard from './BIconCard.stories.ts';
...
<Canvas sourceState="none" of={BIconCard.Default} />
...
<Canvas sourceState="none" of={BIconCard.isIconRound} />
