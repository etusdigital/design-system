...
import * as BInput from './BInput.stories.ts';
...
<Canvas sourceState="none" of={BInput.Primary} />
...
<Canvas sourceState="none" of={BInput.Number} />

<Canvas sourceState="none" of={BInput.Search} />

<Canvas sourceState="none" of={BInput.Color} />

<Canvas sourceState="none" of={BInput.Password} />

<Canvas sourceState="none" of={BInput.File} />

<Canvas sourceState="none" of={BInput.Email} />
...
<Canvas sourceState="none" of={BInput.MaxLetters} />
...
<Canvas sourceState="none" of={BInput.Error} />
...
<Canvas sourceState="none" of={BInput.InfoMessage} />
...
<Canvas sourceState="none" of={BInput.TextArea} />

#### disabled
Disables input interaction. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BInput.Disabled} />

#### required
Marks the field as required. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BInput.Required} />
