	...
	<div
		...
		<div
			...
			<BLabel
				...
				:required="required" />
			<span
				v-if="(max || max == 0) && isTypeValid('text')"
				class="max-length">
...
<style scoped>
	...
	.input-container {
      ...
      outline-neutral-border-default
        rounded-xs
        ...
        px-sm
        min-h-fit
        focus:outline-primary-border-default;
	}

	.input-container.focus {
		@apply outline-primary-border-default;
	}
	...
	.b-input {
		@apply flex-1 bg-transparent text-neutral-foreground-high outline-0 p-0 border-none min-h-xl;
	}
	/* #endregion DEFAULT INPUT STYLE */

	/* #region DISABLED INPUT STYLE */
	.input-container.disabled {
		@apply bg-neutral-surface-disabled text-neutral-foreground-disabled outline-neutral-border-disabled;
	}
	/* #endregion DISABLED INPUT STYLE */

	/* #region ERROR INPUT STYLE */
	.input-container.error {
		@apply text-danger-foreground-low outline-danger-border-default;
	}
	...
	.file {
		@apply relative flex items-center justify-center w-full h-full border-neutral-border-default border-dashed border-xxs cursor-pointer py-xs px-sm;
