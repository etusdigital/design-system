...
} satisfies Meta<typeof ExpandableContainer>;

type Story = StoryObj<typeof ExpandableContainer>;
...
const defaultRender = (args: any) => ({
  components: { ExpandableContainer },
  setup() {
    return { args };
  },
  template: `
    ...
    >
        <Icon name="sentiment_satisfied" size="22px" unfilled class="text-base shrink-0 h-[1em] flex items-center" />
