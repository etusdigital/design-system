...
import * as BStepOption from './BStepOption.stories.ts';
...
<Canvas sourceState="none" of={BStepOption.Primary} />
...
<Canvas sourceState="none" of={BStepOption.Disabled} />

#### is-icon-round
Changes icon display from circular background to plain icon styling. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BStepOption.IsIconRound} />
