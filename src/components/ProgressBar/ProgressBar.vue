...
const component = computed((): string => {
  if (props.infoMessage) return "Tooltip";
  return "div";
});
</script>
...
.progress-holder {
  @apply flex items-center overflow-hidden w-full rounded-base;
}
...
.step-bar .step.filled {
  @apply bg-primary-foreground-low;
}

.progress-bar.neutral-bg,
.step.neutral-bg {
