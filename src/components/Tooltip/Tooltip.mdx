...
import * as Tooltip from './Tooltip.stories.ts';
...
<Canvas sourceState="none" of={Tooltip.Primary} />
...
<Canvas sourceState="none" of={Tooltip.Positions} />
...
<Canvas sourceState="none" of={Tooltip.Label} />
