...
import * as ActionCard from './ActionCard.stories.tsx';
...
<Canvas sourceState="none" of={ActionCard.Primary} />
...
<Canvas sourceState="none" of={ActionCard.HideDrag} />
...
<Canvas sourceState="none" of={ActionCard.Card} />
