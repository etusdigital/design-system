...
import * as BSmartSelect from './BSmartSelect.stories.ts';

<Meta of={BSmartSelect} />
...
<Canvas of={BSmartSelect.Primary} />
<Controls />
...
<Canvas sourceState="none" of={BSmartSelect.Primary} />
...
<Canvas sourceState="none" of={BSmartSelect.InfoMessage} />
...
<Canvas sourceState="none" of={BSmartSelect.CustomItem} />
