...
<template>
  <div ref="bCrop" class="b-crop w-full h-full">
    <div
    ...
    <footer>
      <BIcon name="zoom_out" class="select-none" />
      <BSlider
        v-model="zoom"
        ...
        :max="2"
      />
      <BIcon name="zoom_in" class="select-none" />
    </footer>
  </div>
</template>
...
<style scoped>
.b-crop {
  @apply flex flex-col gap-xs rounded-xl;
}
