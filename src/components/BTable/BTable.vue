      ...
      <thead v-if="!loading">
        <tr>
          ...
          <th
            ...
            :style="{ width: '2%' }"
          >
            <BCheckbox v-model="allSelected" @update:model-value="selectAll" />
          </th>
          <th
...
.b-table-style {
  ...
  thead {
    @apply border-b-xxs border-neutral-default;
  }
...
.skeleton-table-div {
  @apply bg-neutral-surface-disabled h-[14px] w-full bg-gradient-to-r from-transparent via-neutral-surface-default to-transparent;
