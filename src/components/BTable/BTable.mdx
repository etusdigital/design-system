...
import * as BTable from './BTable.stories.ts';
...
<Canvas sourceState="none" of={BTable.Primary} />
...
<Canvas sourceState="none" of={BTable.Options} />
...
<Canvas sourceState="none" of={BTable.Loading} />
...
<Canvas sourceState="none" of={BTable.Selection} />
...
<Canvas sourceState="none" of={BTable.EmptyState} />

#### #footer
Custom table footer content.

<Canvas sourceState="none" of={BTable.Footer} />

#### #items-per-page
Custom text for pagination controls.

<Canvas sourceState="none" of={BTable.ItemsPerPage} />

#### #showing-page
Custom pagination info text.

<Canvas sourceState="none" of={BTable.ShowingPage} />
