...
import * as BMenu from './BMenu.stories';
...
<Canvas sourceState="none" of={BMenu.Primary} />
...
<Canvas sourceState="none" of={BMenu.Expanded} />
...
<Canvas sourceState="none" of={BMenu.WithSideMenu} />
