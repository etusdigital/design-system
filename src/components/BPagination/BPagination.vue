...
<style scoped>
	...
	.page-number {
		@apply text-sm border-xxs border-transparent flex items-end rounded-xs font-medium cursor-pointer px-base py-xs text-neutral-interaction-default hover:text-primary-interaction-hover;
	}

	.page-number.active {
		@apply border-neutral-border-default text-neutral-foreground-high hover:text-neutral-foreground-high;
	}
