...
import * as RadioButton from './RadioButton.stories.ts';
...
<Canvas sourceState="none" of={RadioButton.Primary} />
...
<Canvas sourceState="none" of={RadioButton.Disabled} />

#### is-div
Switches to card-style variant with different styling. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={RadioButton.RadioDiv} />
...
```vue
<template>
    <radio-button v-model="selected" name="options">
        Slot: default
    </radio-button>
</template>
