...
import * as FloatCard from './FloatCard.stories';
...
```vue
<template>
    <float-card v-model="isCardOpen" mode="click">
...
```vue
<template>
    <float-card v-model="showTooltip" mode="hover">
        Slot: default
