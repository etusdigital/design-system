...
import * as BNavbar from './BNavbar.stories';
...
<Canvas sourceState="none" of={BNavbar.Primary} />
...
<Canvas sourceState="none" of={BNavbar.CustomSlots} />
