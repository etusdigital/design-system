...
import * as RoundButton from './RoundButton.stories';
...
<Canvas sourceState="none" of={RoundButton.Primary} />
...
<Canvas sourceState="none" of={RoundButton.Variants} />
...
<Canvas sourceState="none" of={RoundButton.Disabled} />

#### always-open
When true, the text label is always visible instead of only on hover. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={RoundButton.AlwaysOpen} />
