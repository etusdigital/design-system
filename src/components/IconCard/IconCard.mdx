...
import * as IconCard from './IconCard.stories.tsx';
...
<Canvas sourceState="none" of={IconCard.Default} />
...
<Canvas sourceState="none" of={IconCard.IsIconRound} />
