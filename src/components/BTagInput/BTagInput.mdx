...
import * as BTagInput from './BTagInput.stories.ts';
...
<Canvas sourceState="none" of={BTagInput.Primary} />
...
<Canvas sourceState="none" of={BTagInput.IsError} />
