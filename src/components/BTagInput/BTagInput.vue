...
<template>
  <div ref="tagInput" class="b-tag-input">
    <div
      class="flex flex-row justify-between items-center mb-xxs"
      v-if="labelValue"
    >
      <BLabel :label-value="labelValue" :info-message="infoMessage" :required="required" />
      <label
    ...
    >
      ...
      <BTooltip
        ...
        class="max-w-full"
      >
        <BTag color="neutral" class="tag-padding max-w-full" :label-value="tag" closeable @close="removeTag(index)" />
          <template #label>
            <div class="max-w-[100%]">
