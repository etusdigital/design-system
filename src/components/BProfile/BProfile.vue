...
<template>
	<BSelectContainer
		...
		<template #items>
			<div
				class="flex flex-col items-center text-9xl px-xs pb-sm border-b-xxs text-neutral-interaction-default border-neutral-border-default gap-xs">
				<img
			...
			<div class="flex flex-col divide-y-xxs divide-neutral-border-default">
				<div
...
<style scoped>
	...
	.input-default {
		@apply w-full text-sm border-0 border-b-xxs border-neutral-border-default placeholder:text-neutral-interaction-default py-xs pr-xs pl-2xl outline-0;
	}
</style>
