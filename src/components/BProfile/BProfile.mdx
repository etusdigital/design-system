...
import * as BProfile from './BProfile.stories.ts';
...
<Canvas sourceState="none" of={BProfile.Primary} />
...
<Canvas sourceState="none" of={BProfile.Absolute} />

#### disabled
Disables the profile interaction. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BProfile.Disabled} />
...
<Canvas sourceState="none" of={BProfile.Items} />
