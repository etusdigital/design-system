...
import * as BTagSelect from './BTagSelect.stories.ts';
...
<Canvas sourceState="none" of={BTagSelect.Primary} />
...
<Canvas sourceState="none" of={BTagSelect.Icon} />
...
<Canvas sourceState="none" of={BTagSelect.Absolute} />

#### disabled
Disables the tag select interaction. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BTagSelect.Disabled} />

#### required
Marks the field as required. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BTagSelect.Required} />

#### is-error
Activates error styling mode. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BTagSelect.IsError} />
...
<Canvas sourceState="none" of={BTagSelect.InfoMessage} />
