...
import * as BActionCard from './BActionCard.stories.ts';
...
<Canvas sourceState="none" of={BActionCard.Primary} />
...
<Canvas sourceState="none" of={BActionCard.HideDrag} />
...
<Canvas sourceState="none" of={BActionCard.Card} />
