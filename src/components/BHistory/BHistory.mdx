...
import * as BHistory from './BHistory.stories.ts';
...
<Canvas sourceState="none" of={BHistory.Primary} />
...
<Canvas sourceState="none" of={BHistory.MultiType} />
<Canvas sourceState="none" of={BHistory.Icons} />
<Canvas sourceState="none" of={BHistory.IsIconRound} />
<Canvas sourceState="none" of={BHistory.Unfilled} />

#### position
Position of the history timeline relative to content. Type: `"top" | "bottom" | "left" | "right"` (default: `"right"`)

<Canvas sourceState="none" of={BHistory.Positions} />
...
<Canvas sourceState="none" of={BHistory.Types} />

#### disabled
Disables item selection interaction. Type: `boolean` (default: `false`)

<Canvas sourceState="none" of={BHistory.Disabled} />
