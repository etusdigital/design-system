...
<template>
    <BCard id="b-color-picker" class="p-base flex flex-col gap-sm" :class="{ 'no-shadow': noShadow }">
        <div class="relative">
        ...
        <div class="flex items-center gap-sm">
            <BInput v-model="inputColor" @update:model-value="calculateCursor" text-align="center" class="flex-1" />
            <div class="flex items-center gap-xxs">
                <div class="flex flex-col items-center overflow-hidden relative h-[1em] w-fit text-neutral-interaction-default">
