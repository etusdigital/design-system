...
<Canvas sourceState="none" of={PINInputStories.CustomLength} />
...
<Canvas sourceState="none" of={PINInputStories.WithSeparator} />
...
<Canvas sourceState="none" of={PINInputStories.Controlled} />

Control the PIN Input value programmatically with buttons to set or clear the value.

#### OTP Verification

<Canvas sourceState="none" of={PINInputStories.OTP} />

Complete OTP verification flow with loading states and success feedback.
