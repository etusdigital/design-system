...
import * as PINInputStories from './PINInput.stories.tsx';
...
<Canvas of={PINInputStories.Primary} />
<Controls />
...
<Canvas sourceState="none" of={PINInputStories.Primary} />
...
<Canvas sourceState="none" of={PINInputStories.Types} />
