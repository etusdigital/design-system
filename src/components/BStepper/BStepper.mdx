...
import * as BStepper from './BStepper.stories.ts';
...
<Canvas sourceState="none" of={BStepper.Primary} />
...
<Canvas sourceState="none" of={BStepper.Versions} />
