...
import * as BRangeSlider from './BRangeSlider.stories.ts';

<Meta of={BRangeSlider} />
...
<Canvas of={BRangeSlider.Primary} />
<Controls />
...
<Canvas sourceState="none" of={BRangeSlider.Primary} />
...
<Canvas sourceState="none" of={BRangeSlider.Sizes} />
