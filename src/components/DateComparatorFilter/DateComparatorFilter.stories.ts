...
export default {
  component: DateComparatorFilter,
  argTypes: {
    modelValue: {
...
} satisfies Meta<typeof DateComparatorFilter>;

type Story = StoryObj<typeof DateComparatorFilter>;
...
const defaultRender = (args: any) => ({
  components: { DateComparatorFilter },
  setup() {
    return { args };
  },
  template: `
