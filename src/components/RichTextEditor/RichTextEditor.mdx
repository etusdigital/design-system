...
import * as RichTextEditor from './RichTextEditor.stories.tsx';
...
<Canvas sourceState="none" of={RichTextEditor.IsError} />
...
<Canvas sourceState="none" of={RichTextEditor.InfoMessage} />
...
<Canvas sourceState="none" of={RichTextEditor.Required} />
