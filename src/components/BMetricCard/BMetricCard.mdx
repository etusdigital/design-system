...
import * as BMetricCard from './BMetricCard.stories.ts';
...
<Canvas sourceState="none" of={BMetricCard.Primary} />
...
<Canvas sourceState="none" of={BMetricCard.Types} />

#### size
Size variant affecting typography and spacing. Type: `"small" | "medium" | "large"` (default: `"medium"`)

<Canvas sourceState="none" of={BMetricCard.Sizes} />
...
<Canvas sourceState="none" of={BMetricCard.Slots} />
