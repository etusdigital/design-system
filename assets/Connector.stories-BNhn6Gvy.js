import{k as t,_ as e}from"./iframe-BpR-POnt.js";var l,a,r;const s={component:t,argTypes:{vertical:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}}}};var n={render:function(o){return{components:{Connector:t},setup:function(){return{args:o}},template:`<Connector v-model="args.modelValue" :vertical="args.vertical" :disabled="args.disabled" class="items-center">
        <Card class="p-base">
          <Connector>
