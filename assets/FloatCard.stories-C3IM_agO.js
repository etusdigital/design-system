import{p as i,_ as e}from"./iframe-CjRVAs2g.js";var o,t,n,s,d,l;const p={component:i,argTypes:{modelValue:{description:"Controls the visibility state of the floating card."},mode:{type:{name:"string"},control:"select",options:["click","hover"],table:{defaultValue:{summary:"click"}},description:"Interaction mode for showing/hiding the card."}}};var c={modelValue:!1,mode:"click"},u=function(m){return{components:{FloatCard:i},setup:function(){return{args:m}},template:`
    <FloatCard 
