import{u as h,_ as e}from"./iframe-Cbm1DbCo.js";var r,s,u,c,p,d,m,g,f,v,y,b;const _={component:h,argTypes:{modelValue:{type:{name:"other",value:"any"},description:"This will be the selected account."},name:{type:{name:"string"},description:"This property will be the main user name."},picture:{type:{name:"string"},table:{defaultValue:{summary:"person-circle"}},description:"This property will be shown when viewing more user information."},options:{type:{name:"array",value:{name:"object",value:{}}},table:{defaultValue:{summary:"[]"}},description:"If the user have multiple account pass them here."},labelKey:{type:{name:"string"},table:{defaultValue:{summary:"label"}},description:"This the key to get account name in accounts array."},valueKey:{type:{name:"string"},table:{defaultValue:{summary:"value"}},description:"This the key to get account value in accounts array."},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},absolute:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"Makes the content dropdown have an absolute position."},getObject:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},"logout-label":{table:{defaultValue:{summary:"Logout"}},description:"This slot is the logout button text and function that execute when this it's clicked."},"edit-label":{table:{defaultValue:{summary:"Edit Profile"}},description:"This slot is the edit profile button text and function that execute when this it's clicked."},"edit-option":{table:{defaultValue:{summary:"Edit Account"}},description:"This slot is the edit account button text and function that execute when this it's clicked."},option:{description:"This slot will be displayed as an account option. Params: option, index and active."},"privacy-policy":{table:{defaultValue:{summary:"Privacy Policy"}},description:"This slot is the privacy policy text."},"terms-of-use":{table:{defaultValue:{summary:"Terms of Use"}},description:"This slot is the terms of use text."}}};var l={modelValue:"personal-account",name:"John Doe",picture:void 0,absolute:!1,disabled:!1,getObject:!1,options:[{label:"Personal Account",value:"personal-account"},{label:"Work Account",value:"work-account"},{label:"Project Alpha",value:"project-alpha"},{label:"Project Beta",value:"project-beta"},{label:"Development Team",value:"dev-team"}],labelKey:"label",valueKey:"value",logout:function(){},edit:function(){},editOption:function(){},privacyPolicyFunction:function(){},termsOfUseFucntion:function(){}},P=function(i){return{components:{Profile:h},setup:function(){return{args:i}},template:`
    <Profile
