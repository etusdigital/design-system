import{a as m,_ as e}from"./iframe-BB_wyZkI.js";var s,o,i,l,c,d,u,p,f;const x={component:m,argTypes:{icon:{type:{name:"string"},description:"This prop will be the card icon."},color:{type:{name:"string"},table:{defaultValue:{summary:"primary"}},description:"This prop will be the title background color."},hideDrag:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"If this prop is true, the drag icon  won't be shown."},default:{description:"This slot will be the title."},card:{description:"This slot will be the card content."}}};var g={icon:"send",color:"",hideDrag:!1},v=function(r){return{components:{ActionCard:m},setup:function(){return{args:r}},template:`
      <ActionCard class="w-fit" :icon="args.icon" :color="args.color" :hide-drag="args.hideDrag">
        Label
      </ActionCard>
    `}},t={render:v,args:g},n={render:v,args:e(e({},g),{hideDrag:!0})},a={render:function(r){return{components:{ActionCard:m},setup:function(){return{args:r}},template:`
      ...
      `}},args:g};t.parameters=e(e({},t.parameters),{docs:e(e({},(s=t.parameters)===null||s===void 0?void 0:s.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: defaultArgs
}`},(i=(o=t.parameters)===null||o===void 0?void 0:o.docs)===null||i===void 0?void 0:i.source)})});n.parameters=e(e({},n.parameters),{docs:e(e({},(l=n.parameters)===null||l===void 0?void 0:l.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: {
    ...defaultArgs,
    hideDrag: true
