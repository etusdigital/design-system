import{j as o,_ as e}from"./iframe-CEhHUQ6Y.js";var l,a,t;const s={component:o,argTypes:{vertical:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}}}};var n={render:function(r){return{components:{Connector:o},setup:function(){return{args:r}},template:`<Connector v-model="args.modelValue" :vertical="args.vertical" :disabled="args.disabled" class="items-center">
        <Card class="p-base">
          <Connector>
