import{R as g,_ as e}from"./iframe-DkffMcY8.js";var n,d,l,s,t,i,u,m,p;const b={component:g,argTypes:{modelValue:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},groupValue:{description:"Used by the Group component.",type:{name:"other",value:"any"},table:{defaultValue:{summary:"null"}}},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},variant:{type:{name:"string"},control:"select",options:["default","onboarding"],table:{defaultValue:{summary:"default"}},description:"This will be the radio variantion."},default:{description:"This slot will be displayed next to the radio circle."}}};var c={modelValue:!1,groupValue:null,disabled:!1,variant:"default"},v=function(f){return{components:{Radio:g},setup:function(){return{args:f}},template:`
    <Radio 
