import{c as O,_ as e}from"./iframe-BfZTDEbZ.js";var u,p,g,m,c,v,f,b,_,h,y,A,M,x,q,V,E,C;const R={component:O,argTypes:{modelValue:{type:{name:"string"},description:"Will be the input current value."},expanded:{type:{name:"boolean"},description:"Will be the input current value."},labelValue:{type:{name:"string"},description:"Will be the select label."},options:{type:{name:"array",value:{name:"object",value:{}}},description:"Array of values to be used as options."},placeholder:{type:{name:"string"}},required:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"Makes the select container required."},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},isError:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"Activate error mode."},errorMessage:{type:{name:"string"},description:"Will be the error message."},infoMessage:{type:{name:"string"},description:"Will be the info message."},option:{description:"This slot will be displayed as an option. Params: option and index."}}};var r={modelValue:void 0,expanded:!1,options:["Option 1","Option 2","Option 3","Option 4","Option 5"],labelValue:"label",placeholder:"Placeholder",disabled:!1,required:!1,isError:!1,errorMessage:"",infoMessage:""},t=function(i){return{setup:function(){return{args:i}},template:`
  ...
  />`}},a={render:t,args:r},s={render:t,args:e(e({},r),{required:!0})},n={render:t,args:e(e({},r),{disabled:!0})},o={render:t,args:e(e({},r),{isError:!0,errorMessage:"Error message"})},l={render:t,args:e(e({},r),{infoMessage:"Info message"})},d={render:function(i){return{setup:function(){return{args:i}},template:`
    <AutoComplete
      v-model="args.modelValue" 
      v-model:expanded="args.expanded"
      :label-value="args.labelValue"
...
}`},(v=(c=s.parameters)===null||c===void 0?void 0:c.docs)===null||v===void 0?void 0:v.source)})});n.parameters=e(e({},n.parameters),{docs:e(e({},(f=n.parameters)===null||f===void 0?void 0:f.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: {
    ...defaultArgs,
    disabled: true
  }
}`},(_=(b=n.parameters)===null||b===void 0?void 0:b.docs)===null||_===void 0?void 0:_.source)})});o.parameters=e(e({},o.parameters),{docs:e(e({},(h=o.parameters)===null||h===void 0?void 0:h.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: {
    ...defaultArgs,
    isError: true,
...
}`},(A=(y=o.parameters)===null||y===void 0?void 0:y.docs)===null||A===void 0?void 0:A.source)})});l.parameters=e(e({},l.parameters),{docs:e(e({},(M=l.parameters)===null||M===void 0?void 0:M.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: {
    ...defaultArgs,
  ...
  args: defaultArgs
}`},(C=(E=d.parameters)===null||E===void 0?void 0:E.docs)===null||C===void 0?void 0:C.source)})});const I=Object.freeze(Object.defineProperty({__proto__:null,CustomOption:d,Disabled:n,InfoMessage:l,IsError:o,Primary:a,Required:s,default:R},Symbol.toStringTag,{value:"Module"}));export{I as A,d as C,n as D,o as I,a as P,s as R,l as a};
