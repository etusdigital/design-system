import{j as e}from"./index-DhQHbkge.js";import{useMDXComponents as l}from"./index-D2LXvqQ0.js";import{M as o,C as t,a as c}from"./index-CYZ60NiU.js";import{T as d,P as i,O as a,I as h,N as j}from"./Tab.stories-BVR90muc.js";import"./_commonjsHelpers-CqkleIqs.js";import"./preload-helper-PPVm8Dsz.js";import"./index-1y_dBDU3.js";import"./iframe-BuduemLd.js";function r(s){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{of:d}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note"}),": If no initial value is provided, the first option is automatically selected."]}),`
...
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note"}),": The event is emitted with the full option object, but the ",e.jsx(n.code,{children:"v-model"})," binding will store either the value or the object based on ",e.jsx(n.code,{children:"get-object"}),"."]}),`
`,e.jsx(n.h3,{id:"slots-api",children:"Slots API"}),`
`,e.jsxs(n.p,{children:["This component uses internal rendering for tab options and doesn't expose custom slots. All customization is done through props and the ",e.jsx(n.code,{children:"options"})," array structure."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Important Notes:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Auto-selection"}),": Automatically selects the first tab if no initial ",e.jsx(n.code,{children:"v-model"})," value is provided"]}),`
...
`]})]})}function y(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{y as default};
