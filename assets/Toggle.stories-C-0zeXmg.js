import{Z as m,_ as e}from"./iframe-DBfgJmt0.js";var o,t,s,d,u,i,g,p,c;const _={component:m,argTypes:{modelValue:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},groupValue:{description:"Used by the Group component.",type:{name:"other",value:"any"},table:{defaultValue:{summary:"null"}}},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},type:{control:"select",options:["default","secondary"],table:{defaultValue:{summary:"default"}}},default:{description:"This slot will be content inside the toggle."}}};var f={modelValue:!1,groupValue:null,disabled:!1,type:"default"},v=`
  <Toggle 
