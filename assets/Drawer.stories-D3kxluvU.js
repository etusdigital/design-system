import{n as g,_ as e}from"./iframe-Bxd_u4qT.js";var n,s,l,i,u,d,c,p,m;const x={component:g,argTypes:{modelValue:{control:{type:"boolean"},description:"Determine if the dialog is displayed or not."},size:{control:{type:"text"},table:{defaultValue:{summary:"fit-content"}},description:"Determine the drawer size (width for left/right positions, height for top/bottom positions)."},noOutsideClose:{control:{type:"boolean"},table:{defaultValue:{summary:"false"}},description:"Determine if the dialog will not close when the user click outside it."},position:{control:{type:"select"},options:["top","bottom","left","right"],table:{defaultValue:{summary:"right"}},description:"Position where the drawer will slide from."},default:{description:"This slot will be the dialog content."}}};var f={modelValue:!1,size:"40%",noOutsideClose:!1,position:"right"},w=`
