import{q as i,_ as e}from"./iframe-Dk1LHQYl.js";var o,t,n,d,s,l;const p={component:i,argTypes:{modelValue:{description:"Controls the visibility state of the floating card."},mode:{type:{name:"string"},control:"select",options:["click","hover"],table:{defaultValue:{summary:"click"}},description:"Interaction mode for showing/hiding the card."},disabled:{type:{name:"boolean"},control:"boolean",table:{defaultValue:{summary:"false"}},description:"Whether the floating card is disabled."}}};var c={modelValue:!1,mode:"click",disabled:!1},u=function(m){return{components:{FloatCard:i},setup:function(){return{args:m}},template:`
    <FloatCard 
