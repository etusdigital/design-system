import{j as e}from"./iframe-CtDmrYwJ.js";import{useMDXComponents as r}from"./index-DLhRqlSA.js";import{M as d,C as o,a}from"./index-B0RKtGAR.js";import{S as l,P as s,E as c,C as p}from"./Sidebar.stories-B0pmd5vW.js";import"./preload-helper-PPVm8Dsz.js";function t(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:l}),`
...
`,e.jsxs(n.p,{children:["Supports two-way binding via ",e.jsx(n.code,{children:"v-model:expanded"})," so it stays in sync when the user toggles the sidebar themselves (see ",e.jsx(n.code,{children:"collapsible"}),")."]}),`
`,e.jsx(o,{sourceState:"none",of:c}),`
`,e.jsx(n.h4,{id:"collapsible",children:"collapsible"}),`
`,e.jsxs(n.p,{children:["Renders a toggle button at the bottom of the sidebar so the user can expand/collapse it themselves. Type: ",e.jsx(n.code,{children:"boolean"})," (default: ",e.jsx(n.code,{children:"false"}),"). Pair with ",e.jsx(n.code,{children:"v-model:expanded"})," to read the current state."]}),`
...
`,e.jsxs(n.p,{children:["Triggered when the user toggles the sidebar via the ",e.jsx(n.code,{children:"collapsible"})," button. Receives the new ",e.jsx(n.code,{children:"boolean"})," expanded state. Enables ",e.jsx(n.code,{children:"v-model:expanded"}),"."]}),`
...
`]})]})}function b(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{b as default};
