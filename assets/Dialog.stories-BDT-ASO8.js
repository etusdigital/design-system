import{m as d,_ as e}from"./iframe-NRhvH3fl.js";var s,n,l,o,i,r;const g={component:d,argTypes:{modelValue:{type:{name:"boolean"},description:"Determine if the dialog is displayed or not."},width:{type:{name:"string"},table:{defaultValue:{summary:"fit-content"}},description:"Determine the dialog width."},height:{type:{name:"string"},table:{defaultValue:{summary:"fit-content"}},description:"Determine the dialog height."},noOutsideClose:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"Determine if the dialog will not close when the user click outside it."},class:{type:{name:"string"},table:{defaultValue:{summary:""}},description:"Add custom CSS classes to the dialog element."},zIndex:{type:{name:"number"},table:{defaultValue:{summary:"1002"}},description:"Determine the z-index of the dialog overlay (backdrop)."},default:{description:"This slot will be the dialog content."}}};var u={modelValue:!1,width:"60%",height:"fit-content",noOutsideClose:!1,class:"",zIndex:1002},c=function(m){return{components:{Dialog:d},setup:function(){return{args:m}},template:`
