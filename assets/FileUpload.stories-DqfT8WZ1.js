import{F as P,_ as e}from"./iframe-DeP1hNCB.js";var c,g,m,f,v,b,_,y,h,V,M,F,U,S,A,z,x,D,R,j,E,w,O,I;const W={component:P,argTypes:{modelValue:{type:{name:"other",value:"File | File[] | undefined"},description:"Will be the uploaded file(s). Can be a single File or File[] if multiple is true."},labelValue:{type:{name:"string"},description:"Will be the file upload label."},errorMessage:{type:{name:"string"},description:"Will be the file upload error message."},placeholder:{type:{name:"string"},description:"Will be the file upload placeholder text."},isError:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"Ative error mode."},size:{type:{name:"string"},description:"Will be file upload size.",control:"select",options:["small","medium","large"],table:{defaultValue:{summary:"medium"}}},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"Disables the file upload functionality."},accept:{description:'Specifies the types of files that the server accepts. E.g., ".jpg,.png,.pdf"'},multiple:{table:{defaultValue:{summary:"(value)=>{void}"}},description:"Allows multiple file selection."},"uploaded-file":{description:"Custom slot for displaying uploaded file information"}}};var a={modelValue:void 0,labelValue:"Upload File",errorMessage:"",placeholder:"or drag and drop it here",isError:!1,size:"medium",disabled:!1,infoMessage:"",accept:void 0,multiple:!1},C=`
    <FileUpload
        class="h-fit"
    ...
    />`,r=function(p){return{components:{FileUpload:P},setup:function(){return{args:p}},template:C}},l={render:r,args:a},s={render:r,args:e(e({},a),{labelValue:"Upload Image",accept:".jpg,.jpeg,.png,.gif",infoMessage:"Only image files allowed"})},o={render:r,args:e(e({},a),{labelValue:"Upload Multiple Files",multiple:!0,infoMessage:"Select multiple files or drag them here"})},i={render:r,args:e(e({},a),{labelValue:"Upload with Info",infoMessage:"Maximum file size: 10MB. Supported formats: PDF, DOC, DOCX"})},n={render:r,args:e(e({},a),{labelValue:"Upload with Error",isError:!0,errorMessage:"File upload failed. Please try again."})},d={render:r,args:e(e({},a),{labelValue:"Disabled Upload",disabled:!0})},t={render:r,args:e(e({},a),{labelValue:"Required Upload",required:!0})},u={render:function(p){return{components:{FileUpload:P},setup:function(){return{args:p}},template:`
      <div class="flex flex-col gap-xs">
        `.concat(["small","medium","large"].map(function(q){return C.replace(/args\.size/g,"'".concat(q,"'")).replace(/args\.labelValue/g,"'".concat(q,"'"))}).join(""),`
      </div>
...
}`},(A=(S=n.parameters)===null||S===void 0?void 0:S.docs)===null||A===void 0?void 0:A.source)})});d.parameters=e(e({},d.parameters),{docs:e(e({},(z=d.parameters)===null||z===void 0?void 0:z.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: {
    ...defaultArgs,
...
}`},(D=(x=d.parameters)===null||x===void 0?void 0:x.docs)===null||D===void 0?void 0:D.source)})});t.parameters=e(e({},t.parameters),{docs:e(e({},(R=t.parameters)===null||R===void 0?void 0:R.docs),{source:e({originalSource:`{
  render: defaultRender,
  args: {
    ...defaultArgs,
