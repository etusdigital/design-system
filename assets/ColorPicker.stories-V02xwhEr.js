import{i as v,_ as e}from"./iframe-BByBBolI.js";var s,n,l,d,t,i,u,p,c;const f={component:v,argTypes:{modelValue:{type:{name:"string"}},type:{type:{name:"string"},control:"select",options:["hexa","hsla","hwb","hsva","rgba"],table:{defaultValue:{summary:"hexa"}},description:"This property will be the color type."},noShadow:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"When noShadow property is true, the card will have no shadow."},showAlpha:{type:{name:"boolean"},table:{defaultValue:{summary:"true"}},description:"When true, the opacity/alpha slider is shown."},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"When disabled is true, the color picker is non-interactive."}}};var m={modelValue:"",type:"hexa",noShadow:!1,showAlpha:!0,disabled:!1},h=function(g){return{components:{ColorPicker:v},setup:function(){return{args:g}},template:`
    <ColorPicker
