import{$ as _,_ as e}from"./iframe-DuEF8bwq.js";var s,d,u,i,c,p,g,v,m,f,y,b;const x={component:_,argTypes:{modelValue:{type:{name:"other",value:"any"},table:{defaultValue:{summary:"undefined"}}},vertical:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},disabled:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}}},type:{control:"select",options:["default","secondary"],table:{defaultValue:{summary:"default"}}}}};var o={modelValue:1,vertical:!1,disabled:!1,options:[{label:"First",value:1},{label:"Second",value:2},{label:"Third",value:3}],labelKey:"label",valueKey:"value",getObject:!1,type:"default"},V=`
  <ToggleGroup
