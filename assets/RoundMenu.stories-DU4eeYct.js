import{z as t,_ as n}from"./iframe-BB_wyZkI.js";var a,i,e;const l={component:t,argTypes:{options:{type:{name:"array",value:{name:"object",value:{}}},table:{defaultValue:{summary:"[]"}},description:"This property will be options in menu. Props(label: string, icon: string, background: string, action: ()=>{void})"}}};var o={render:function(c){return{components:{RoundMenu:t},setup:function(){return{args:c}},template:`
