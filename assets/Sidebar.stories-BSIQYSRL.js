import{G as i,_ as e}from"./iframe-B-QOi4Vs.js";var l,r,n,o,s,d;const b={component:i,argTypes:{modelValue:{type:{name:"other",value:"any"},description:"Will name of the selected option."},options:{type:{name:"array",value:{name:"object",value:{}}},description:"Array of object to be used as sidebar options. Props(label: string, value: string, icon: string, path: string, disabled: boolean, bottom: boolean, options: Option[])"},expanded:{type:{name:"boolean"},description:"If true, the sidebar will be expanded."},getObject:{type:{name:"boolean"},table:{defaultValue:{summary:"false"}},description:"If true, the selected value will be an object instead of value-key value."}}};var p={modelValue:"dashboard",getObject:!1,expanded:!1,options:[{label:"Dashboard",value:"dashboard",icon:"dashboard",path:"/"},{label:"Projects",value:"projects",icon:"folder",options:[{label:"All Projects",value:"rew-projects",path:"/all",options:[{label:"All Projects",value:"all-projects",path:"/all"},{label:"Internal",value:"internal",path:"/internal"},{label:"External",value:"external",path:"/external"}]},{label:"Internal",value:"internal",path:"/internal"},{label:"External",value:"external",path:"/external"}]},{label:"Team",value:"team",path:"/team",icon:"group"},{label:"Analytics",value:"analytics",path:"/analytics",icon:"analytics",disabled:!0},{label:"Settings",value:"settings",path:"/settings",icon:"settings",bottom:!0}]},u=function(c){return{components:{Sidebar:i},setup:function(){return{args:c}},template:`
    <div class="h-screen">
      <Sidebar
