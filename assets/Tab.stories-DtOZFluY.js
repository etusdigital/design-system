import{T as _,_ as e}from"./iframe-CjRVAs2g.js";var l,d,i,u,p,c,m,v,g,b,y,f;const O={component:_,argTypes:{modelValue:{type:{name:"other",value:"any"},description:"Will the current tab.",table:{defaultValue:{summary:void 0}}},options:{type:{name:"array",value:{name:"object",value:{}}},description:"Array of values to be used as options."},labelKey:{type:{name:"string"},description:"Property name used for displaying option labels when using object arrays.",table:{defaultValue:{summary:"label"}}},valueKey:{type:{name:"string"},description:"Property name used for displaying option values when using object arrays.",table:{defaultValue:{summary:"value"}}},isIcon:{type:{name:"boolean"},description:"Show icons instead of words.",table:{defaultValue:{summary:"false"}}},notCard:{type:{name:"boolean"},description:"No card will wrapper the options.",table:{defaultValue:{summary:"false"}}}}};var s={modelValue:void 0,options:["Option 1","Option 2","Option 3","Option 4","Option 5"],labelKey:"label",valueKey:"value",isIcon:!1,notCard:!1},t=function(h){return{components:{Tab:_},setup:function(){return{args:h}},template:`
    <Tab
        class="w-fit"
